        ...
        <div  id="container">
            ...
            <!--<span id="search">
                ...
                <div id="menu" class="menu">
                    ...
                    <div id="curdiv"><a id="current" href="about.php">Об авторе</a><a href="about.php">Об авторе</a></div>
                    <div id="info">
            ...
            <div id="body">
                <div id="title-row">
                    <div><img id="img" src="..\img\myphoto.jpg" alt="Белевцов С.В."></div>
                   <div id="name">Об авторе</div>
                </div>
                <div id="content">
                    <p class="center">
                        <span class="letter">Б</span>елевцов <span class="letter">С</span>ергей <span class="letter">В</span>алерьевич
                    </p>
                    <ul class="text">
                        <li>20 лет, мужской</li>
                        <li>belevtsov_sergey@mail.ru, +380662938262</li>
                        <li>ХНЭУ 2013-2018</li>
                        <li>Русский, украинский, английский</li>
                        <li>Windows, PHP, MySQL, HTML, CSS, JS, C++, C#, Java, ADO.Net</li>
                        <li>Adobe Photoshop</li>
                        <li>Не женат, детей нет</li>
                    </ul>                    
                    <div id="partners">
